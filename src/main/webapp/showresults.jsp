...
<body>
		...
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div class="ml-auto">
				<a href="<%=request.getContextPath()%>/list" class="nav-link"
					style="color: #fff; font-weight: bold; background-color: #007bff; padding: 10px 20px; border-radius: 5px;">Back to Employee List</a>
			</div>
			<div class="ml-auto">
	...
	<div class="containertab">
		<h3 class="text-center">Employees Searched List</h3>
	</div>
	<br>
