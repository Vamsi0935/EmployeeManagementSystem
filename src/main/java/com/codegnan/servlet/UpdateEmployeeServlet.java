...
public class UpdateEmployeeServlet extends HttpServlet {
	...
	private static final Logger logger = Logger.getLogger(UpdateEmployeeServlet.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Employee employee = new Employee(id, fullname, gender, email, salary, skills, role, qualification, state);
